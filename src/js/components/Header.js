...
const Header = (props) =>{
    ...
    let {currentTheme, handleChangeTheme} = props;
        ...
        <header className='major-bg lighter-font'>
          ...
          <div className='header-right'>
            <label className='theme-toggler-wrapper'>
              <input type='checkbox' id='theme-toggler' onChange={handleChangeTheme} checked = {currentTheme === 'dark' ? false : true} data-testid='theme' />
