...
import {setLocalTheme, getLocalTheme, fetchQuote} from './utils/utilities';
import logo from '../img/diqs-logo.png';
      ...
      <div className={currentTheme === 'dark' ? `wrapper dark-theme` : `wrapper light-theme`} data-testid='wrapper'>
        <header className='major-bg lighter-font'>
          ...
          <div className='header-right'>
            ...
            <a href='https://github.com/emmadonjo/daily-inspirational-quotes' target='_blank' title='Visit Github Repo'>
            ...
            <div className='content'>
              ...
              <>
                ...
                <div className='tags-share '>
                  ...
                  <div className='share'>
                    <a href='https://twitter.com/content/tweet' id='tweet-quote' target='_blank' className='lighter-font' data-testid='tweet'>tweet</a>
                  </div>
                </div>
              </>
              }
